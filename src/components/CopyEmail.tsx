...
const CopyEmail = () => {
    const functionCopy = () => {
        navigator.clipboard.writeText('gerardporras@gmail.com');
    };

    return (
        <div className="flex">
            <span className="rounded-s-md border border-e-0 border-yellow-500 bg-yellow-500/10 ps-2.5 pe-2 py-0.5 text-sm text-yellow-500">gerardporras@gmail.com</span>
